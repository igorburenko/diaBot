...
btn_main_menu = telebot.types.InlineKeyboardButton(text=u"\U0001F519 Главная", callback_data="back2main_menu")
...
btn_gratitude = telebot.types.InlineKeyboardButton(text=u"\U0001F64FCopyright", callback_data="gratitude")
