...
btn_delete_menu = telebot.types.InlineKeyboardButton(text=u"\U0000274C Удалить меню", callback_data="delete_my_menu")
btn_calculate = telebot.types.InlineKeyboardButton(text=u"\U0001F4BB Расчитать", callback_data="calculate")
btn_my_menu_1 = telebot.types.InlineKeyboardButton(text=u"\U0001F4BB Меню 1", callback_data="Switch_menu, 1")
btn_my_menu_2 = telebot.types.InlineKeyboardButton(text=u"\U0001F4BB Меню 2", callback_data="Switch_menu, 2")
btn_my_menu_3 = telebot.types.InlineKeyboardButton(text=u"\U0001F4BB Меню 3", callback_data="Switch_menu, 3")
